...
class CallStateMonitor extends Handler {
    ...
    public static final int INTERNAL_PHONE_MWI_CHANGED = 16;
    public static final int INTERNAL_SHOW_MESSAGE_NOTIFICATION_DONE = 17;
    public static final int INTERNAL_UPDATE_IN_CALL_NOTIFICATION = 18;
