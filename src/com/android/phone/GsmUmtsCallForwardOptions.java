...
public class GsmUmtsCallForwardOptions extends TimeConsumingPreferenceActivity 
    ...
    private static final String BUTTON_CFUT_KEY = "button_cfut_key";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mButtonCFUT   = (CallForwardEditPreference) prefSet.findPreference(BUTTON_CFUT_KEY);
    ...
    public void onResume() {
        ...
        if (mFirstResume) {
            if (mIcicle == null) {
                ...
                mPreferences.get(mInitIndex).init(this, false, mSubscription, mServiceClass);
            } else {
                ...
                for (CallForwardEditPreference pref : mPreferences) {
                    ...
                    pref.init(this, true, mSubscription, mServiceClass);
                }
            }
            mFirstResume = false;
            mIcicle=null;
        ...
        try {
            ...
            switch (requestCode) {
                ...
                case CommandsInterface.CF_REASON_NOT_REACHABLE:
                    ...
                    break;
                case CommandsInterface.CF_REASON_UNCONDITIONAL_TIMER:
                    mButtonCFUT.onPickActivityResult(cursor.getString(0));
                    break;
                default:
